...
@section('content')
    ...
    <section class="uza-portfolio-area section-padding-80">
        ...
        <div class="portfolio-menu text-center mb-80">
            <button class="btn active" data-filter="*">All Books</button>
            <button class="btn" data-filter=".ux-ui-design">General Knowlege</button>
            <button class="btn" data-filter=".marketing-social">Hight School</button>
            <button class="btn" data-filter=".market-analytics">Kid</button>
        </div>
            ...
            <div class="row uza-portfolio">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item ux-ui-design">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/general knowlege/81eX-e1z3QL.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h4>Why we want to RICH</h4>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item market-analytics">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/Kid/2389-9_actualsize.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h4>Every Body as Something to Give</h4>
                            <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no sea takimata sanctus est</p>
                        </div>
                        <!-- View More -->
                        <div class="view-more-btn">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item ux-ui-design">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/general knowlege/22255137_1460082114060452_3050526878694304826_o.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h4>Advandced Object General Knowlege</h4>
                            <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no sea takimata sanctus est</p>
                        </div>
                        <!-- View More -->
                        <div class="view-more-btn">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item market-analytics">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/Kid/9781419729454_l.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item ux-ui-design">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/general knowlege/81bsw6fnUiL.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item marketing-social">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/higtSchool/physic.jpg" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h4>Physic</h4>
                            <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no sea takimata sanctus est</p>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item marketing-social">
                    <div class="single-portfolio-slide">
                        <img src="./img/Book/higtSchool/chemistry.png" alt="">
                        <!-- Overlay Effect -->
                        <div class="overlay-effect">
                            <h4>Chemistry</h4>
                            <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet gubergren no sea takimata sanctus est</p>
