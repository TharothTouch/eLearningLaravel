                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-text">
                                        <h2 data-animation="fadeInUp" data-delay="100ms">Improving Live<br>Through<span>Learning</span></h2>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="welcome-thumbnail">
                                    <img src="./img/bg-img/0.1.png" alt="" data-animation="slideInRight" data-delay="400ms">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="about-us-content mb-80">
                        <h2 style="color: #1583e9 ">A Great Place to Grow &amp; Get Something New</h2>
                        <p>Teachers, reseachers and students live out value every day as learner and teachers ourselves.</p>
                        <p>Our culture is sharing, give feedback, and try to get something new from all over the world and all of you.</p>
                        <a href="#" class="btn uza-btn btn-2 mt-4">Join our team</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <p>Process, to evaluate the functionality of a software application with an intent to find whether the developed software.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>UI/UX Design</h5>
                        <p>Our UI/UX designers create web and mobile user interfaces. We make apps that are simple, beautiful, and useful.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-service-area mb-80">
                        ...
                        <h5>Advertising</h5>
                        <p>Marketing communication that employs an openly sponsored, non-personal message to promote or sell a product, service or idea.</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="portfolio-sildes owl-carousel">
                    ...
                    <div class="single-portfolio-slide">
                        <img src="./img/bg-img/022.png" alt="">
                        <!-- Overlay Effect -->
